...
<html>
	...
	<!--取出上一个页面上带来的page的值-->
		...
		<div id="addAll">
			...
			<div id="table">
				<form action="${pageContext.request.contextPath}/prod/save.do" enctype="multipart/form-data"
							...
							<td>
								...
								<script type="text/javascript">
									function myclose(ispage) {
										window.location="${pageContext.request.contextPath}/prod/split.do?page="+ispage;
									}
								</script>
							</td>
						</tr>
