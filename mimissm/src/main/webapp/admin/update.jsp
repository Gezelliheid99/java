		...
		<div id="addAll">
			...
			<script type="text/javascript">
				function fileChange(){//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
					...
					$.ajaxFileUpload({
						url: '${pageContext.request.contextPath}/prod/ajaxImg.do',//用于文件上传的服务器端请求地址
...
<script type="text/javascript">
	function myclose(ispage) {
		...
		//window.close();
			...
			<div id="table">
				<form action="${pageContext.request.contextPath}/prod/update.do" enctype="multipart/form-data" method="post" id="myform">
					...
					<table>
						...
						<tr>
							...
							<td> <br><div id="imgDiv" style="display:block; width: 40px; height: 50px;">
								<img src="${pageContext.request.contextPath}/image_big/${prod.pImage}" width="100px" height="100px" ></div><br><br><br><br>
